...
- [ ] Unit tests for every feature and update before build & package
- [ ] Test webview functionality in isolation
- [ ] Verify all UI components render correctly
- [ ] Test all user interactions (clicks, drags, inputs)
- [ ] Verify message passing between extension and webview
- [ ] Test with different screen sizes and VS Code themes
- [ ] Test iframe loading for all supported websites
- [ ] Verify splitter/resize functionality works properly
- [ ] Test hover functionality (title attributes, tooltips)
- [ ] Validate Content Security Policy doesn't block legitimate content
- [ ] Test error handling for network issues
- [ ] Verify all configuration options work as expected
- [ ] Run automated test suite with `npm test` or equivalent
- [ ] Test cross-platform compatibility (Windows, macOS, Linux)
- [ ] Verify extension doesn't cause memory leaks or performance issues
- [ ] Test with extension disabled/enabled scenarios