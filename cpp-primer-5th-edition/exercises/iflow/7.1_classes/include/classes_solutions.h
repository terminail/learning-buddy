#ifndef CLASSES_SOLUTIONS_H
#define CLASSES_SOLUTIONS_H
...
/**
 * @class PointSolutions
 * @brief Solution implementation for Point class
 * 
 * This class demonstrates proper class structure with constructors,
...
public:
     ...
     */
    PointSolutions(double x, double y);
     ...
     */
    double distance_to(const PointSolutions& other) const;
...
/**
 * @class StudentSolutions
 * @brief Solution implementation for Student class
 * 
...
public:
     ...
     */
    StudentSolutions(const std::string& name, int id);
