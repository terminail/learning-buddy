...
# Exercise 2.1.1: Variables and Basic Types

This exercise introduces you to C++ variables and basic data types. You'll learn how to declare, initialize, and use variables of different types.

## Learning Objectives

- Understand C++ basic data types (int, double, char, bool, string)
- Learn how to declare and initialize variables
- Practice using variables in simple programs
- Understand the difference between variable declaration and initialization

## Exercise Files

- [variables_types_exercises.cpp](src/variables_types_exercises.cpp) - Your exercise implementation
- [variables_types_solutions.cpp](src/variables_types_solutions.cpp) - Reference solution
- [test_variables_types_basics.cpp](test/test_variables_types_basics.cpp) - Basic tests
- [test_variables_types_practice.cpp](test/test_variables_types_practice.cpp) - Practice problems

## Instructions

1. Open [variables_types_exercises.cpp](src/variables_types_exercises.cpp)
2. Follow the TODO comments to declare and initialize variables of different types
3. Compile and run your program to see the output
4. Compare your solution with [variables_types_solutions.cpp](src/variables_types_solutions.cpp)

## Variables and Basic Types Overview

In C++, variables are used to store data. Each variable has a type that determines what kind of data it can hold. The basic types include:
...
1. Understand how to declare and initialize variables
2. Know the basic C++ data types
3. Be able to print variables to the console
4. Understand the difference between different data types

Continue with the next exercise to learn about operators and expressions.