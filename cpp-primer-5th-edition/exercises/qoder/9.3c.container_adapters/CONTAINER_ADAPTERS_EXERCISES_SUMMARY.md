...
### 9.3a: Stack Basics
**Directory**: ../9.3a.container_adapters/stack_basics/
...
**Directory**: [priority_queue_basics](priority_queue_basics/)
...
| Adapter | Access Pattern | Key Operations | Primary Use Cases |
|---------|----------------|----------------|-------------------|
| Stack | LIFO | push, pop, top | Function calls, undo |
| Queue | FIFO | push, pop, front, back | BFS, task queues |
| Priority Queue | Priority | push, pop, top | Scheduling, algorithms |
