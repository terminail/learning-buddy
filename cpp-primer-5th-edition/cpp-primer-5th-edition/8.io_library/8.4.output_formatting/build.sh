...
# Build script for output formatting exercise

echo "Building output formatting exercise..."
...
echo "Run the exercises with: ./build/output_formatting_exercises"
echo "Run the solutions with: ./build/output_formatting_solutions"