@echo off
REM Test runner script for output formatting exercise

REM Build first if needed
if not exist "build\test_output_formatting_basics.exe" if not exist "build\test_output_formatting_practice.exe" (
...
test_output_formatting_basics.exe > basics_output.txt 2>&1
test_output_formatting_practice.exe > practice_output.txt 2>&1
