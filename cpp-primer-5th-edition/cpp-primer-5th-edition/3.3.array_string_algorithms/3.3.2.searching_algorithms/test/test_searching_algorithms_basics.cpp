...
TEST(SearchingAlgorithmsTest, StringSearching) {
    // Use the same string as in the solution file
    ...
    EXPECT_EQ(7, it - text.begin());  // "World" starts at position 7 in "Hello, World!..."
    ...
    EXPECT_EQ(31, end_it - text.begin());  // Last 'o' in "Programming"
}