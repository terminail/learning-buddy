...
TEST(SortingAlgorithmsPractice, ComplexScenarios) {
    ...
    // Expected order: Bob(25,60000), Diana(25,50000), Charlie(30,55000), Alice(30,50000)
    // Age 25: Bob (60000.0) comes before Diana (50000.0) due to salary descending
    // Age 30: Charlie (55000.0) comes before Alice (50000.0) due to salary descending
    EXPECT_EQ("Bob", people[0].name);
    EXPECT_EQ("Diana", people[1].name);
