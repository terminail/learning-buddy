@echo off
REM Test runner script for smart pointers basics exercise

REM Build first if needed
if not exist "build\test_smart_pointers_basics_basics.exe" if not exist "build\test_smart_pointers_basics_practice.exe" (
...
echo Running all smart pointers basics tests...
test_smart_pointers_basics_basics.exe > basics_output.txt 2>&1
test_smart_pointers_basics_practice.exe > practice_output.txt 2>&1
