@echo off
REM Test runner script for lambda expressions basics exercise

REM Build first if needed
if not exist "build\test_lambda_expressions_basics_basics.exe" if not exist "build\test_lambda_expressions_basics_practice.exe" (
...
echo Running all lambda expressions basics tests...
test_lambda_expressions_basics_basics.exe > basics_output.txt 2>&1
test_lambda_expressions_basics_practice.exe > practice_output.txt 2>&1
