@echo off
REM Test runner script for arithmetic_operators exercise (Windows)

REM Build first if needed
if not exist "build\test_arithmetic_operators_basics.exe" if not exist "build\test_arithmetic_operators_practice.exe" (
...
test_arithmetic_operators_basics.exe > basics_output.txt 2>&1
test_arithmetic_operators_practice.exe > practice_output.txt 2>&1
