@echo off
REM Test runner script for multiple inheritance exercise

REM Build first if needed
if not exist "build\test_multiple_inheritance_basics.exe" if not exist "build\test_multiple_inheritance_practice.exe" (
...
test_multiple_inheritance_basics.exe > basics_output.txt 2>&1
test_multiple_inheritance_practice.exe > practice_output.txt 2>&1
