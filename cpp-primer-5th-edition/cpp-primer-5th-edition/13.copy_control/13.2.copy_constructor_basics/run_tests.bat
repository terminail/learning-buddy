@echo off
REM Test runner script for copy constructor basics exercise

REM Build first if needed
if not exist "build\test_copy_constructor_basics_basics.exe" if not exist "build\test_copy_constructor_basics_practice.exe" (
...
echo Running all copy constructor basics tests...
test_copy_constructor_basics_basics.exe > basics_output.txt 2>&1
test_copy_constructor_basics_practice.exe > practice_output.txt 2>&1
