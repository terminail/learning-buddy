@echo off
REM Test runner script for variable_declarations exercise (Windows)

REM Build first if needed
if not exist "build\test_variable_declarations_basics.exe" if not exist "build\test_variable_declarations_practice.exe" (
...
test_variable_declarations_basics.exe > basics_output.txt 2>&1
test_variable_declarations_practice.exe > practice_output.txt 2>&1
