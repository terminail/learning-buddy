...
# Build script for function parameters exercise
...
echo "Run the exercises with: ./build/function_parameters_exercises"
echo "Run the solutions with: ./build/function_parameters_solutions"