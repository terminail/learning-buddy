...
# Build script for function overloading exercise
...
echo "Run the exercises with: ./build/function_overloading_exercises"
echo "Run the solutions with: ./build/function_overloading_solutions"