@echo off
REM Test runner script for comparison operators exercise

REM Build first if needed
if not exist "build\test_comparison_operators_basics.exe" if not exist "build\test_comparison_operators_practice.exe" (
...
test_comparison_operators_basics.exe > basics_output.txt 2>&1
test_comparison_operators_practice.exe > practice_output.txt 2>&1
