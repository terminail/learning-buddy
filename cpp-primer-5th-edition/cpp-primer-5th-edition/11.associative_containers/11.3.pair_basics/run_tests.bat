@echo off
REM Test runner script for pair basics exercise

REM Build first if needed
if not exist "build\test_pair_basics_basics.exe" if not exist "build\test_pair_basics_practice.exe" (
...
echo Running all pair basics tests...
test_pair_basics_basics.exe > basics_output.txt 2>&1
test_pair_basics_practice.exe > practice_output.txt 2>&1
