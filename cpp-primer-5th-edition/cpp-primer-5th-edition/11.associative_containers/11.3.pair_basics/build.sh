...
# Build script for pair basics exercise

echo "Building pair basics exercise..."
...
echo "Run the exercises with: ./build/pair_basics_exercises"
echo "Run the solutions with: ./build/pair_basics_solutions"