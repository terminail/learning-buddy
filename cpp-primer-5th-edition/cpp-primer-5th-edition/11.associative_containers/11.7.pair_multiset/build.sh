...
# Build script for pair multiset exercise

echo "Building pair multiset exercise..."
...
echo "Run the exercises with: ./build/pair_multiset_exercises"
echo "Run the solutions with: ./build/pair_multiset_solutions"