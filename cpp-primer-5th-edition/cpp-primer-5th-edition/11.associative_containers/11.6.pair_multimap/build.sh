...
# Build script for pair multimap exercise

echo "Building pair multimap exercise..."
...
echo "Run the exercises with: ./build/pair_multimap_exercises"
echo "Run the solutions with: ./build/pair_multimap_solutions"