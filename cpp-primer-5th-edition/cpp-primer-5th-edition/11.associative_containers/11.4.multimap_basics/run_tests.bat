@echo off
REM Test runner script for multimap basics exercise

REM Build first if needed
if not exist "build\test_multimap_basics_basics.exe" if not exist "build\test_multimap_basics_practice.exe" (
...
echo Running all multimap basics tests...
test_multimap_basics_basics.exe > basics_output.txt 2>&1
test_multimap_basics_practice.exe > practice_output.txt 2>&1
