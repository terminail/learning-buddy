@echo off
REM Test runner script for map basics exercise

REM Build first if needed
if not exist "build\test_map_basics_basics.exe" if not exist "build\test_map_basics_practice.exe" (
...
echo Running all map basics tests...
test_map_basics_basics.exe > basics_output.txt 2>&1
test_map_basics_practice.exe > practice_output.txt 2>&1
