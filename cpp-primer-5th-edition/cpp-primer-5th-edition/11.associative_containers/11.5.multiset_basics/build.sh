...
# Build script for multiset basics exercise

echo "Building multiset basics exercise..."
...
echo "Run the exercises with: ./build/multiset_basics_exercises"
echo "Run the solutions with: ./build/multiset_basics_solutions"