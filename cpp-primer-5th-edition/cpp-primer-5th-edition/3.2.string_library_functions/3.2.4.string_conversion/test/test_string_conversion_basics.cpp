...
TEST(StringConversionTest, StringToIntegerFunctions) {
    ...
    // Test stol - using a value within the range of long on this platform
    std::string long_str = "2147483647";  // Maximum value for 32-bit long
    long converted_long = std::stol(long_str);
    EXPECT_EQ(2147483647L, converted_long);
