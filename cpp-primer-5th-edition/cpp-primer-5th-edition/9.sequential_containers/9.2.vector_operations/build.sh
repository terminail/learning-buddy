...
# Build script for vector operations exercise

echo "Building vector operations exercise..."
...
echo "Run the exercises with: ./build/vector_operations_exercises"
echo "Run the solutions with: ./build/vector_operations_solutions"