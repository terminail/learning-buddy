...
echo "Building container adapters exercise..."
...
echo "Run the exercises with: ./build/container_adapters_exercises"
echo "Run the solutions with: ./build/container_adapters_solutions"