@echo off
REM Test runner script for vector basics exercise

REM Build first if needed
if not exist "build\test_vector_basics_basics.exe" if not exist "build\test_vector_basics_practice.exe" (
...
test_vector_basics_basics.exe > basics_output.txt 2>&1
test_vector_basics_practice.exe > practice_output.txt 2>&1
