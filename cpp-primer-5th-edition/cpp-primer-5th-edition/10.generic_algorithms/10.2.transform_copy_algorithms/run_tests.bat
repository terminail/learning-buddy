@echo off
REM Test runner script for transform_copy_algorithms exercise

REM Build first if needed
if not exist "build\test_transform_copy_algorithms_basics.exe" if not exist "build\test_transform_copy_algorithms_practice.exe" (
...
echo Running all transform copy algorithms tests...
test_transform_copy_algorithms_basics.exe > basics_output.txt 2>&1
test_transform_copy_algorithms_practice.exe > practice_output.txt 2>&1
