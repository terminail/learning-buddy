@echo off
REM Test runner script for basic sorting algorithms exercise

REM Build first if needed
if not exist "build\test_basic_sorting_algorithms_basics.exe" if not exist "build\test_basic_sorting_algorithms_practice.exe" (
...
echo Running all basic sorting algorithms tests...
test_basic_sorting_algorithms_basics.exe > basics_output.txt 2>&1
test_basic_sorting_algorithms_practice.exe > practice_output.txt 2>&1
