@echo off
REM Test runner script for advanced sorting algorithms exercise

REM Build first if needed
if not exist "build\test_advanced_sorting_algorithms_basics.exe" if not exist "build\test_advanced_sorting_algorithms_practice.exe" (
...
test_advanced_sorting_algorithms_basics.exe > basics_output.txt 2>&1
test_advanced_sorting_algorithms_practice.exe > practice_output.txt 2>&1
