@echo off
REM Test runner script for numeric_algorithms exercise

REM Build first if needed
if not exist "build\test_numeric_algorithms_basics.exe" if not exist "build\test_numeric_algorithms_practice.exe" (
...
test_numeric_algorithms_basics.exe > basics_output.txt 2>&1
test_numeric_algorithms_practice.exe > practice_output.txt 2>&1
