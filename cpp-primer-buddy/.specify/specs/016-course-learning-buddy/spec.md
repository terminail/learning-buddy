...
**See Also**: [Course Structure Tool specification](../015-course-structure-tool/spec.md) for details on validating and generating course structure files.
...
**Note**: Course Learning Buddy extensions are designed to focus on a single course and do not support switching between different courses. For multi-course functionality, users should install the generic Learning Buddy extension.
...
1. **Given** a "C++ Primer 5th Edition Buddy" extension installation, **When** the extension is opened, **Then** the C++ Primer 5th Edition outline should be displayed by default.
2. **Given** a "Python 3rd Edition Buddy" extension installation, **When** the extension is opened, **Then** the Python 3rd Edition outline should be displayed by default.
...
2. **Given** a Course Learning Buddy with protected content, **When** I access that content with a valid license, **Then** it should be delivered through the Podman environment without additional setup.
...
### User Story 5 - Promote Generic Learning Buddy for Multi-Course Access (Priority: P2)

As a student using a Course Learning Buddy, I want to be informed about how to access other courses so that I can explore additional learning materials.

**Why this priority**: This enhances the learning experience by enabling course discovery.

**Independent Test**: Can be tested by installing a Course Learning Buddy and verifying that promotional positions for the generic Learning Buddy are displayed.

**Acceptance Scenarios**:

1. **Given** a Course Learning Buddy, **When** I view the course outline, **Then** I should see a promotional position for the generic Learning Buddy at the bottom.
2. **Given** the promotional position for generic Learning Buddy, **When** I click on it, **Then** I should be directed to information about installing the generic Learning Buddy extension.
...
- What happens when a Course Learning Buddy is built with an invalid Podmanfile?
...
- **FR-012**: System MUST support course-specific Podmanfiles for development environment configuration
- **FR-013**: System MUST validate that Course Learning Buddy repositories follow the required structure
- **FR-014**: System MUST NOT support course switching within Course Learning Buddy extensions
- **FR-015**: System MUST provide clear promotion for generic Learning Buddy extension for multi-course access
- **FR-016**: System SHOULD provide templates for common Course Learning Buddy configurations
- **FR-017**: System SHOULD support versioning for Course Learning Buddy
- **FR-018**: System MUST ensure Course Learning Buddy can be updated without losing user data
- **FR-019**: System MUST handle Course Learning Buddy updates gracefully
...
- **SC-009**: Course Learning Buddy MUST NOT support course switching functionality
- **SC-010**: Course Learning Buddy MUST provide clear promotion for generic Learning Buddy extension
- **SC-011**: Course Learning Buddy can be updated without losing user data in 100% of cases
- **SC-012**: Course Learning Buddy repositories following the required structure are validated successfully in 95% of cases